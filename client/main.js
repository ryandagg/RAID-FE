...
// Game constants
var RenderConstants = require('../lib/RenderConstants');
            ...
            <Well>
                ...
                <Accordion>
                    ...
                    <Panel header="GameConstants" eventKey="4">
                        ...
                        <ul className="list-unstyled">
                            {/* todo: Use actual code instead of duplicating here */}
...
var Raid = React.createClass({
    getInitialState: function() {
        var gR = new GameRunner(this.renderUI, RenderConstants.RENDER_WITH_CANVAS ? this.renderCanvas : null);
        ...
        return {
            ...
            "level": 1,
            "message": "Welcome!",
            "renderer": RenderConstants.RENDER_WITH_CANVAS ? "canvas" : "table",
            "canvas": canvas,
